...
import { getAntiSpam } from '../services/tgcApi';
...
const AntiSpam = ({ data }) => {
  ...
  const pageSeo = {
    title: 'Anti Spam | The Green Channel',
    description:
      "Please read The Green Channel's complete Anti Spam. If you have any concerns, email our team at webmaster@thegreenchannel.tv. Thanks!",
    keyword: '',
  };
...
export const getServerSideProps = async ({ req, res, params }) => {
  let htmlData;
  try {
    const res = await getAntiSpam(req.headers.cookie);
    if (res.data.status) {
